...
public interface WikiCons {
	...
	String TABLE_END = "|}";
	String TABLE_START = "{|";
	String TEMPLATE_BEGIN = LEFT_CURLY_BRACKET + LEFT_CURLY_BRACKET + LEFT_CURLY_BRACKET;
	String TEMPLATE_END = RIGHT_CURLY_BRACKET + RIGHT_CURLY_BRACKET + RIGHT_CURLY_BRACKET;
	String TILDE = "~";
	String TILDE_U = "&#x007E;";
