...
public class TableGroupRenderer implements Renderer {
	...
	public TableGroupRenderer() {
		...
		list.add(new TableRenderer(WikiCons.TABLE_ALT_COMMA_START, WikiCons.TABLE_ALT_END, WikiCons.COMMA,
				HTMLTag.TABLE_START_PRE, HTMLTag.TABLE_START_POST, HTMLTag.TABLE_END, HTMLTag.ROW_START,
				HTMLTag.ROW_END, HTMLTag.CELL_START, HTMLTag.CELL_END));

		list.add(new TableRenderer(WikiCons.TABLE_ALT_SEMICOLON_START, WikiCons.TABLE_ALT_END, WikiCons.SEMICOLON,
				HTMLTag.TABLE_START_PRE, HTMLTag.TABLE_START_POST, HTMLTag.TABLE_END, HTMLTag.ROW_START,
				HTMLTag.ROW_END, HTMLTag.CELL_START, HTMLTag.CELL_END));

		list.add(new TableRenderer(WikiCons.TABLE_ALT_TAB_START, WikiCons.TABLE_ALT_END, WikiCons.TAB,
				HTMLTag.TABLE_START_PRE, HTMLTag.TABLE_START_POST, HTMLTag.TABLE_END, HTMLTag.ROW_START,
				HTMLTag.ROW_END, HTMLTag.CELL_START, HTMLTag.CELL_END));

		list.add(new TableRenderer(WikiCons.TABLE_START, WikiCons.TABLE_END, WikiCons.NEW_ROW, WikiCons.NEW_CELL,
				WikiCons.NEW_CELL_SAME_LINE, HTMLTag.TABLE_START_PRE, HTMLTag.TABLE_START_POST, HTMLTag.TABLE_END,
				HTMLTag.ROW_START, HTMLTag.ROW_END, HTMLTag.CELL_START, HTMLTag.CELL_END));
